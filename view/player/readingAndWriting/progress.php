            ...
            <div class="progreso_circulo">
                ...
                <div class="row">
                    <div class="col-12 mt-1">            
                        ...
                        <div class="num_start ">                                  
                            ...
                            <span class="fs-4"><strong><?php echo $total_stars; ?></strong> <e>Estrella(s)</e> </span>
                        </div>
                    </div>
                
                    <div class="rayita"></div>
                </div>
                <h2 class="fw-bold" style="color: var(--color-azul)">Etapa 1, seccion 1</h2>
                <p style="color:grey">
                ...
                <div class="row ">
                    <div class="col-12 mt-0">
                        ...
                        <div class="num_start ">                                  
                            <i class="bi bi-star-fill fs-4 text-warning"></i>
                            <span class="fs-4"><strong><?php echo $stage_1_stats["stars"] ?? 0; ?></strong> <e>Estrella(s)</e> </span>
                        </div>
                    </div>
                    </div> 
                    <div class="rayita"></div>
                </div>
                <h2 class="fw-bold" style="color: var(--color-azul)">Etapa 1, seccion 2</h2>
                <p style="color:grey">
                    <div class="d-flex align-items-center">
                        <img 
                ...
                <div class="row ">
                    <div class="col-12 mt-0">
                        ...
                        <div class="num_start ">                                  
                            <i class="bi bi-star-fill fs-4 text-warning"></i>
                            <span class="fs-4"><strong><?php echo $stage_2_stats["stars"] ?? 0; ?></strong> <e>Estrella(s)</e> </span>
                        </div>
                    </div>
