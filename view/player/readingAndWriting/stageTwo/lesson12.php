...
namespace View\player\readingAndWriting\stageTwo;
...
// init stage
$stage = new Stage(4, $_SESSION['user_id']);

// check for lesson permissions
$lesson = new Lesson(26, $_SESSION['user_id']);
$lesson->startLesson();
...
<head>
    ...
    <link rel="stylesheet" href="../../../../css/player/they_do_read/leccion_12.css">
    <link rel="stylesheet" href="../../../../css/player/they_do_read/animation_intentos.css">
    <style>
        main {
