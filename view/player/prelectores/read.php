...
for ($index = 0; $index < $stage_2_lessons_amount; $index++) {
    ...
    $stage_2_lessons[$index] = new Lesson(
        ...
        $_SESSION['user_id'], 
        $stage_1_lessons_amount + ((!!$index) ? $index : 1)
    ); 
}
...
<body style="background-image: url(/img/player/fondo.png);">
    <div data-include="/view/includeHTMLsinPhp/player/header.php"></div>
    <main>
                ...
                <div class="col-xl-10 col-lg-12">
                    <div class="mensaje_actualizacion" mensaje_actualizacion="show">
                        <div class="mensaje_actualizacion-body">
                            <strong class=" ">
                                <i 
                                    class="bi bi-volume-up mensaje__actualizacion--audio me-1 "
                        ...
                        <button 
                            type="button" 
                            class=" me-2 m-auto mensaje_actualizacion--button"
                        > 
                        ...
                        <div class="etapa_uno_seccion_uno">
                            ...
                            >
                                ...
                                <div class="container-guia guiaAudio">
                                    <a href="./guide/oneGuide.php" style="color: inherit;text-decoration: none;">
                                        <i
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                <div class="estado_juego">
                                                    <img src="<?php echo $stage_1_lessons[1]?->isLocked() ? './../../../img/caritas/candado.png' : '/img/caritas/check.png' ?>" style="width:2.5rem" alt="">
                                                </div>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                <div class="estado_juego">
                                                    <img 
                                                        src="<?php echo $stage_1_lessons[3]?->isLocked() ? '/img/caritas/candado.png' : '/img/caritas/check.png' ?>" 
                                                        style="width:2.5rem"
                                                        alt=""
                                                    >
                                                </div>
                                    ...
                                    <div class="styles_cuaderno"
                                        ...
                                        <div class="carita" style="text-align: center; color:white; ">
                                            <div>
                                                <div class="estado_juego">
                                                    <img 
                                                        src="<?php echo $stage_1_lessons[7]?->isLocked() ? '/img/caritas/candado.png' : '/img/caritas/check.png' ?>"
                        ...
                        <div class="etapa_uno_seccion_dos">
                            <div class="d-flex justify-content-between  align-items-center" style="margin: 0rem 1rem;">
                                ...
                                <div class="container-guia">
                                    <a href="./guide/TwoGuide.php" style="color: inherit !important;
  text-decoration: none;"><i
                                            class="bi bi-journal-text"></i><span>GUIA</span></a>
                            ...
                            <div class="container__styles_leccion">
                                <?php
                                    ...
                                    $callback = !!$lesson9 
                                        ? "updateInputs({$lesson9["id_leccion"]}, {$lesson9["estrellas"]}, {$lesson9["porcentaje"]}, 1)" 
                                        : "updateInputs(9, 0, 0, 2)";
                                ?>
                                <button 
                                    type="button" 
                                    class="btn" 
                            ...
                            <div class="container__styles_leccion">
                                <?php
                                    ...
                                    $callback = !!$lesson10 
                                        ? "updateInputs({$lesson10["id_leccion"]}, {$lesson10["estrellas"]}, {$lesson10["porcentaje"]}, 1)" 
                                        : "updateInputs(10, 0, 0, 2)";
                                ?>
                                <button 
                                    type="button" 
                                    class="btn" 
                                    data-bs-toggle="modal" 
                                    data-bs-target="<?php echo $stage_2_lessons[1]?->isLocked() ? '#no_acceso' : '#entrar_leccion' ?>"
                                    onclick='<?php echo $callback; ?>'
                                >
                                    <div class="styles_cuaderno"
                                        style="  filter: drop-shadow(2px 4px 0px #1795d1);background-image: linear-gradient(45deg, #1CB0F6 30%, #16a0e1 30% 50%, #1CB0F6 50% 60%, #16a0e1 60% 65%, #1CB0F6 56% 100%);">
                                ...
                                <?php
                                    ...
                                    $callback = !!$lesson11 
                                        ? "updateInputs({$lesson11["id_leccion"]}, {$lesson11["estrellas"]}, {$lesson11["porcentaje"]}, 1)" 
                                        : "updateInputs(11, 0, 0, 2)";
                                ?>
                                <button 
                                    type="button" 
                                    class="btn" 
                            ...
                            <div class="container__styles_leccion">
                                <?php
                                    ...
                                    $callback = !!$lesson12 
                                        ? "updateInputs({$lesson12["id_leccion"]}, {$lesson12["estrellas"]}, {$lesson12["porcentaje"]}, 1)" 
                                        : "updateInputs(12, 0, 0, 2)";
                                ?>
                                <button 
                                    type="button" 
                                    class="btn" 
                                ...
                                <?php
                                    ...
                                    $callback = !!$lesson13 
                                        ? "updateInputs({$lesson13["id_leccion"]}, {$lesson13["estrellas"]}, {$lesson13["porcentaje"]}, 1)" 
                                        : "updateInputs(13, 0, 0, 2)";
                                ?>
                                <button 
                                    type="button" 
                                    class="btn" 
                            ...
                            <div class="container__styles_leccion">
                                <?php
                                    ...
                                    $callback = !!$lesson14 
                                        ? "updateInputs({$lesson14["id_leccion"]}, {$lesson14["estrellas"]}, {$lesson14["porcentaje"]}, 1)" 
                                        : "updateInputs(14, 0, 0, 2)";
                                ?>
                                <button 
                                    type="button" 
                                    class="btn" 
                ...
                <div class="col-5  col-xl-3 text-center">
                    <div class="progreso_tabla">
                        ...
                        <div class="progreso_usuario-flex">
                            <span class="fs-4 ">
                                <i 
                                    class="bi bi-volume-up progreso_audio fs-4 me-1 m-0 p-0  "
                                    style="font-size:1.1rem"
                                ></i>Tu Progreso
                            </span>
                            <div class="num_start">
    ...
    <script>
        ...
        $lesson_modal.addEventListener("focus", (event) => {
            ...
            $modal_url.setAttribute("href", `./stage${$stage_input.value === '1' ? 'One' : 'Two' }/lesson${$lesson_input.value}.php`);
