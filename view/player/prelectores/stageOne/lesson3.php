...
$lesson = new Lesson(3, $_SESSION['user_id']);
$lesson->startLesson();
...
<body>
    <main>
            ...
            <div class="container-xxl">
                <div class="tableContainer align-items-center justify-content-center" data-next="2">
                    <div class="containerColButton">
                        <div class="lettersButtons colButton" id="one">
                            <button data-check="false">?</button>
                            <button  data-check="false">?</button>
                            <button  data-check="false">?</button>
                        </div>
                        <div class="lettersButtons colButton" id="two">
                            <button  data-check="false">?</button>
                            <button  data-check="false">?</button>
                            <button  data-check="false">?</button>
                        </div>
        ...
        <div class="messengerUserContainer">
            <div class="messengerInformation animate__backInDown" style="display:none">
                ...
                <p>Encuentra los elementos iguales, de ⬅ a ➡.</p>
            </div>
        </div>
        ...
        <audio src="/audio/welcome_jugador/soundWineer.mp3" class="soundWineer"></audio>
        <audio src="/audio/welcome_jugador/ceroIntentos.mp3" class="ceroIntentos"></audio>
        <audio src="/audio/welcome_jugador/SoundAllwrong.mp3" class="SoundAllwrong"></audio>
    ...
    <script src="/js/player/they_do_not_read/etapa_1_seccion_1/leccion_3.js" type="module"></script>
</body>
