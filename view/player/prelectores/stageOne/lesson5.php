...
$lesson = new Lesson(5, $_SESSION['user_id']);
$lesson->startLesson();
...
<head>
    ...
    <style>
        ...
        .containerColButton>div {
            width: clamp(700px, 40%, 70px);
        }


        .colButton>button {
            width: clamp(150px, 20%, 20px) !important;
        }

        .wordButtons {
            width: clamp(300px, 40%, 70px);
        }
        ...
        .wordButtons>button {
            ...
            margin-bottom: 0.6rem;
            width: auto;
            width: clamp(160px, 20%, 20px) !important;
        }
...
<body>
    <main>
                ...
                <div class="tableContainer align-items-center justify-content-center" data-next="2">
                    ...
                    <div class="containerColButton">
                        <div class="wordButtons">
                            <button>
                                <img src="" alt="" data-number="1">
                                <small class="font-size: .6em;"></small>
                            </button>
                            <button>
                                <img src="" alt="" data-number="2">
                                <small class="font-size: .6em;"></small>
                            </button>
                            <button>
                                <img src="" alt="" data-number="3">
                                <small class="font-size: .6em;"></small>
                            </button>
                        </div>
                    </div>
        ...
        <div class="messengerUserContainer">
            <div class="messengerInformation animate__backInDown" style="display:none">
                ...
                <p>Seleccione el dibujo que comienza con la letra indicada en el recuadro.</p>
            </div>
        </div>
    ...
    <script src="/js/player/they_do_not_read/etapa_1_seccion_1/leccion_5.js" type="module"></script>
</body>
