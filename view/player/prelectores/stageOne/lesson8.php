...
$lesson = new Lesson(8, $_SESSION['user_id']);
$lesson->startLesson();
...
<body>
    <main>
            ...
            <div class="container-xxl">
                ...
                <div class="tableContainer align-items-center justify-content-center" data-next="5"
                    ...
                    <div class="containerColButton">
                        <div class="colButton colButton_1">
                            <button>?</button>
                ...
                <br>
                <div class="containerIntentos" style="display:none">
                    <span class="intentos">
        ...
        <div class="containerResults" style="display: none;">
            <div class="w-auto text-center"
                ...
                <div class="first">
                    <b>En el primer ejercicio...</b><br>
                    <span class="correctFailedP"></span><br>
                    <hr>
                    <b>En el segundo ejercicio...</b><br>
                    <span class="correctFailedEjercicioVisual"></span><br>
                    <hr>
    ...
    <script src="/js/player/they_do_not_read/etapa_1_seccion_1/leccion_8.js" type="module"></script>
</body>
