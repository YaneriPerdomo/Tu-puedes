...
namespace View\player\prelectores\stageTwo;
...
// init stage
$stage = new Stage(2, $_SESSION['user_id']);

// check for lesson permissions
$lesson = new Lesson(11, $_SESSION['user_id']);
$lesson->startLesson();
...
<body>
    <main>
        ...
        <div class="messengerUserContainer">
            <div class="messengerInformation animate__backInDown" style="display:none">
                ...
                <p>Seleccione la palabra que comienza con la letra indicada en el cuadro.</p>
            </div>
        </div>
    ...
    <script src="/js/player/they_do_not_read/etapa_1_seccion_1/leccion_11.js" type="module"></script>
</body>
